  ...
  if ($showUpdateAvail || $needscheck[0]) {
    ...
    if ($fp = @fopen ("http://www.phplist.com/files/LATESTVERSION","r")) {
      ...
      if ($showUpdateAvail || !versionCompare($thisversion,$latestversion)) {
        ...
        print '<a href="https://www.phplist.com/news">'.$GLOBALS['I18N']->get('View what has changed').'</a>&nbsp;&nbsp;';
        print '<a href="https://www.phplist.com/download">'.$GLOBALS['I18N']->get('Download').'</a></div>';
      }
    }
